...
public class SeparatorDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            Log.i("SeparatorDecoration", "Position is: " + p + "View Type is: " + viewType);
            view.getClass().toString();
            Log.i("ViewClass","Position is: " + p + " View Type is:  " + viewType +" View Type is: "+view.getClass().toString());

            if (viewType == 2) {
                c.drawLine(view.getLeft() + mMarginLeft, view.getBottom() + offset,
                        view.getRight(), view.getBottom() + offset, mPaint);

                c.drawLine(view.getRight() - mMarginRight-offset, view.getTop(),
                        view.getRight() - mMarginRight-offset, view.getBottom(), mPaint);
            }
